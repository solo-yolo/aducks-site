(() => {
  ...
  // dist/build/_fallback-18420c3d.js
  var require_fallback_18420c3d = __commonJS((exports) => {
    __export(exports, {
      default: () => fallback_18420c3d_default
    });
    ...
    class fallback_18420c3d_default extends main.S {
      constructor(s2) {
  ...
  // dist/build/index-bb436db3.js
  var require_index_bb436db3 = __commonJS((exports) => {
    __export(exports, {
      default: () => index_bb436db3_default
    });
    const main = __toModule(require_main());
    function f(s2) {
      let t2, o2, u2, f2, d2, h, g, x, b = s2[0].message + "";
      return {c() {
        t2 = main.e("section"), o2 = main.e("div"), u2 = main.e("p"), u2.textContent = "yo", f2 = main.a(), d2 = main.e("p"), h = main.t(b), g = main.t(" from "), x = main.t(s2[1]), main.b(o2, "class", "box"), main.b(t2, "class", "section");
      }, m(s3, e2) {
        main.c(s3, t2, e2), main.d(t2, o2), main.d(o2, u2), main.d(o2, f2), main.d(o2, d2), main.d(d2, h), main.d(d2, g), main.d(d2, x);
      }, p(s3, [t3]) {
        1 & t3 && b !== (b = s3[0].message + "") && main.h(h, b);
      }, i: main.n, o: main.n, d(s3) {
        s3 && main.f(t2);
      }};
    }
    function d(s2, t2, o2) {
      const e2 = "http://aducks-api.herokuapp.com/";
      main.m.title = "\u0410\u0443\u0442\u044F\u0442\u0430", main.m.description = "Description coming soon...";
      let a2 = {};
      return console.log(`api url: ${e2}`), fetch(e2 + "/foo").then((s3) => s3.json()).then((s3) => {
        o2(0, a2 = s3);
      }), [a2, e2];
    }
    class index_bb436db3_default extends main.S {
      constructor(s2) {
        super(), main.i(this, s2, d, f, main.s, {});
      }
    }
  });

  // dist/build/_layout-3140043f.js
  var require_layout_3140043f = __commonJS((exports) => {
    __export(exports, {
      default: () => layout_3140043f_default
    });
    const main = __toModule(require_main());
    function w(n2, a2, s2) {
      const t2 = n2.slice();
    ...
    function z(n2) {
      ...
      return {c() {
        ...
        l2 && l2.p && 1 & a3 && main.r(l2, e2, n3, n3[0], a3, null, null);
      }, i(n3) {
        t2 || (main.v(a2.$$.fragment, n3), main.v(l2, n3), t2 = true);
      }, o(n3) {
        main.w(a2.$$.fragment, n3), main.w(l2, n3), t2 = false;
      }, d(n3) {
        main.x(a2, n3), n3 && main.f(s2), l2 && l2.d(n3);
      }};
    }
    function A(n2, a2, s2) {
    ...
    class layout_3140043f_default extends main.S {
      constructor(n2) {
  ...
  var require_main = __commonJS((exports) => {
    ...
    function B() {
      if (!q) {
        ...
        do {
          ...
          for (k(null), S.length = 0; I.length; )
            I.pop()();
    ...
    function U(t2) {
      if (t2.fragment !== null) {
        ...
        const e2 = t2.dirty;
        t2.dirty = [-1], t2.fragment && t2.fragment.p(t2.ctx, e2), t2.after_update.forEach(A);
      }
    }
    const H = new Set();
    let K;
    ...
    function tt(e2, n2, i2, s2, a2, c2, l2 = [-1]) {
      ...
      if (p2.ctx = i2 ? i2(e2, n2.props || {}, (t2, n3, ...o2) => {
        ...
        return p2.ctx && a2(p2.ctx[t2], p2.ctx[t2] = r2) && (!p2.skip_bound && p2.bound[t2] && p2.bound[t2](r2), f2 && function(t3, e3) {
          t3.$$.dirty[0] === -1 && (S.push(t3), T(), t3.$$.dirty.fill(0)), t3.$$.dirty[e3 / 31 | 0] |= 1 << e3 % 31;
        }(e2, t2)), n3;
    ...
    function Ot(e2) {
      ...
      for (let t2 = 0; t2 < i2.length; t2 += 1) {
        let n3 = Pt(e2, i2, t2), a2 = s2(n3);
        r2.set(a2, o2[t2] = kt(a2, n3));
      }
      return {c() {
        n2 = y("div");
        ...
        1 & e3 && (i2 = t2[0], o2 = V(o2, e3, s2, 1, t2, i2, r2, n2, G, kt, null, Pt));
      }, i: t, o: t, d(t2) {
        t2 && m(n2);
        for (let t3 = 0; t3 < o2.length; t3 += 1)
          o2[t3].d();
    ...
    const jt = mt([]);
    const Et = gt(jt, (t2) => t2.slice(0, 2));
    function St(t2) {
      const e2 = t2.data ? t2.data.prefetchId : t2;
      if (!e2)
        return null;
      const n2 = c(jt).find((t3) => t3 && t3.options.prefetch == e2);
      if (n2) {
        ...
        Promise.all([o2, r2]).then(() => {
          jt.update((t4) => t4.filter((t5) => t5.options.prefetch != e2));
        });
      }
    }
    ...
    class Lt extends et {
      constructor(t2) {
        super(), tt(this, t2, It, Ot, s, {});
      }
    }
    function Ft() {
      return E("routify") || bt;
    }
    const Nt = {_hooks: [(t2) => _t.set(false)], subscribe: Tt};
    const Rt = {_hooks: [], subscribe: Tt};
    function Tt(t2) {
    ...
    const Mt = {subscribe: (t2) => gt([Ft(), yt, $t], (t3) => function(t4, e2, n2) {
    ...
    const At = {subscribe: (t2) => gt([Mt, yt], ([t3, e2]) => function(n2 = "", o2 = {}, {strict: r2} = {strict: true}) {
    ...
    const qt = {props: {}, templates: {}, services: {plain: {propField: "name", valueField: "content"}, twitter: {propField: "name", valueField: "content"}, og: {propField: "property", valueField: "content"}}, plugins: [{name: "applyTemplate", condition: () => true, action: (t2, e2) => [t2, (qt.getLongest(qt.templates, t2) || ((t3) => t3))(e2)]}, {name: "createMeta", condition: () => true, action(t2, e2) {
      ...
      const n2 = document.getElementsByTagName("head")[0], o2 = t2.match(/(.+)\:/), r2 = o2 && o2[1] || "plain", {propField: i2, valueField: s2} = Ct.services[r2] || Ct.services.plain, a2 = document.querySelector(`meta[${i2}='${t2}']`);
      a2 && a2.remove();
    ...
    const Ct = new Proxy(qt, {set(t2, e2, n2, o2) {
    ...
    function Ut(t2) {
      ...
      return {c() {
        ...
        4194365 & n3 && (i2 = [t3[4]], D(), o2 = V(o2, n3, s2, 1, t3, i2, r2, e2.parentNode, Q, Jt, e2, Bt), J());
      }, i(t3) {
        if (!n2) {
    ...
    function Kt(t2) {
      ...
      return {c() {
        ...
        t3[18] && t3[1].length ? o2 ? (o2.p(t3, n3), 16 & n3 && z(o2, 1)) : (o2 = Ht(t3), o2.c(), z(o2, 1), o2.m(e2.parentNode, e2)) : o2 && (D(), W(o2, 1, 1, () => {
          o2 = null;
        }), J());
      }, i(t3) {
        n2 || (z(o2), n2 = true);
    ...
    function zt(e2) {
      ...
      return {c() {
        ...
        t2[4] ? c2 ? (c2.p(t2, e3), 16 & e3 && z(c2, 1)) : (c2 = Ut(t2), c2.c(), z(c2, 1), c2.m(n2.parentNode, n2)) : c2 && (D(), W(c2, 1, 1, () => {
          c2 = null;
        }), J());
      }, i(t2) {
        r2 || (z(c2), r2 = true);
    ...
    function Wt(t2, e2, n2) {
      ...
      function $2(t3) {
        n2(5, m2 = {...p2}), h2.length === 0 && async function() {
          ...
          !window.routify.stopAutoReady && t4 && async function({page: t5, metatags: e4, afterPageLoad: n3}) {
            const {path: o3} = t5, {options: r3} = ct(), i3 = r3.prefetch;
          ...
          }({page: a2.component, metatags: Ct, afterPageLoad: Nt});
        }();
      ...
      return j("routify", g2), t2.$$set = (t3) => {
        ...
        }(d2), 16 & t2.$$.dirty && a2 && at(a2, M);
      }, [p2, u2, f2, d2, a2, m2, g2, y2, (t3) => c2 = t3.parentNode, r2, i2];
    }
    class Gt extends et {
      constructor(t2) {
        super(), tt(this, t2, Wt, zt, s, {nodes: 1, scoped: 0, decorator: 2});
      }
    }
    function Qt(t2, e2) {
      let n2 = false;
      function o2(o3, r3) {
        const i2 = xt(o3 || ct().fullpath);
        i2.redirectTo && (history.replaceStateNative({}, null, i2.redirectTo), delete i2.redirectTo);
        const s2 = [...(r3 && xt(ct().fullpath, t2) || i2).layouts, i2];
      ...
      const r2 = function(t3) {
        ...
        const n3 = {click: Vt, pushstate: () => t3(), replacestate: () => t3(), popstate: async (n4) => {
          e3 ? e3 = false : await Zt(n4, ct().fullpath) ? t3() : (e3 = true, n4.preventDefault(), history.go(1));
        }};
    ...
    async function Zt(t2, e2) {
      const n2 = xt(e2).api;
      for (const o2 of Rt._hooks.filter(Boolean)) {
    ...
    function Yt(t2) {
      ...
      return n2 = new Lt({}), {c() {
        ...
        t3[0] && t3[1] !== null ? r2 ? (r2.p(t3, n3), 3 & n3 && z(r2, 1)) : (r2 = Xt(t3), r2.c(), z(r2, 1), r2.m(e2.parentNode, e2)) : r2 && (D(), W(r2, 1, 1, () => {
          r2 = null;
        }), J());
      }, i(t3) {
    ...
    function te(t2, e2, n2) {
      ...
      return f2 = u2, O().$$.on_destroy.push(f2), t2.$$set = (t3) => {
        ...
        4 & t2.$$.dirty && s2 && (clearTimeout(p2), p2 = setTimeout(() => {
          u2(), i2 = Qt(s2, c2), $t.set(s2), i2.updatePage();
        }));
      }, [r2, o2, s2, a2];
    }
    class ee extends et {
      constructor(t2) {
        super(), tt(this, t2, te, Yt, s, {routes: 2, config: 3});
      }
    }
    function ne(t2) {
    ...
    var $e = Object.freeze({__proto__: null, setRegex: se, setParamKeys: ae, setShortPath: ce, setRank: le, addMetaChildren: ue, setIsIndexable: pe, assignRelations: fe, assignIndex: me, assignLayout: ge, createFlatList: (t2) => {
      ne((t3) => {
    ...
    const Pe = {...$e, restoreDefaults: ({tree: t2}) => we(t2), assignAPI: _e};
    const ke = {root: true, ownMeta: {preload: "proximity"}, children: [{isFallback: true, meta: {recursive: true, preload: "proximity", prerender: true}, path: "/_fallback", component: () => Promise.resolve().then(() => __toModule(require_fallback_18420c3d())).then((t2) => t2.default)}, {isIndex: true, isPage: true, meta: {recursive: true, preload: "proximity", prerender: true}, path: "/index", id: "_index", component: () => Promise.resolve().then(() => __toModule(require_index_bb436db3())).then((t2) => t2.default)}], isLayout: true, meta: {preload: "proximity", recursive: true, prerender: true}, path: "/", id: "__layout", component: () => Promise.resolve().then(() => __toModule(require_layout_3140043f())).then((t2) => t2.default)};
    const {tree: Oe, routes: je} = function(t2) {
    ...
    function Ee(e2) {
      let n2, o2;
      return n2 = new ee({props: {routes: je}}), {c() {
        Z(n2.$$.fragment);
      }, m(t2, e3) {
        X(n2, t2, e3), o2 = true;
      }, p: t, i(t2) {
